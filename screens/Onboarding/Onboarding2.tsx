  ...
  return (
    <ScrollView className="flex-1 bg-gradient-to-b from-lime-400 to-lime-300">
      <View className="flex-1 items-center justify-center px-6 pb-6">
        {/* Logo */}
        <View className="mb-6">
            <Image source={require('../../assets/images/Onboard2.png')} style={{ width: 450, height: 550, borderBottomLeftRadius: 50,
    ...
    overflow: 'hidden'}} />
        ...
        <View className="mt-8 items-center px-6">
          <Text className="text-2xl font-bold text-gray-800 text-center mb-3">
            Gain Insight into Your Nutrition and Health
          </Text>
          <Text className="text-gray-600 text-center text-sm leading-5">
            See how your food choices impact your health and well-being with our comprehensive nutrition insights.
          </Text>
        </View>
        ...
        <View className="flex-row space-x-4 mt-8 px-6 w-full max-w-sm gap-4">
          <TouchableOpacity className="flex-1 bg-white rounded-full py-4 border border-gray-200" onPress={()=> navigate.goBack()}>
            <Text className="text-center font-semibold text-gray-700">Back</Text>
          </TouchableOpacity>
          <TouchableOpacity className="flex-1 bg-lime-500 rounded-full py-4" onPress={() => navigate.navigate('Onboarding3')}>
